            ...
            <div className={styles.firstCont}>
                ...
                <div className={styles.about}>
                    ...
                    <ul>
                        ...
                        <li>gymbuddiesteamservice@gmail.com</li>
                    </ul>
                </div>
            </div>

            <div>
                <p className={styles.pElement}>© {new Date().getFullYear()} Copyright <span>|</span> Made by Emil Stoychev</p>
            </div>
        </footer>
    )
}