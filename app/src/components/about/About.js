...
const About = () => {
    ...
    // useEffect(() => {
    //     taskService.toDoAppInNumbers()
    //         .then(res => setCountCont([res.users, res.tasks, res.fiveStars]))
    // }, [])
    ...
    const rateHandler = (e) => {
        ...
        //     taskService.rateUs(localStorage.getItem('sessionStorage'), e.target.value)
        //         .then(res => {
        //             if (!res.message) {
        ...
        <div className={styles?.['about-cont']}>
            ...
            <div className={styles?.['numberCounting-div']}>
                <div className={styles?.["numberCounting"]}>
                    ...
                    <span className={styles.num} data-val={countCont[0]}>4</span>
                    <span className={styles.text}>Happy Users</span>
                </div>
                <div className={styles?.["numberCounting"]}>
                    <i className="fas fa-list"></i>
                    <span className={styles.num} data-val={countCont[1]}>0</span>
                    <span className={styles.text}>ToDo Tasks</span>
                </div>
                <div className={styles?.["numberCounting"]}>
                    <i className="fas fa-star"></i>
                    <span className={styles.num} data-val={countCont[2] * 0.95}>4</span>
