          ...
          <div className={styles.taskInfo}>
            ...
            <div className={styles.taskInfoSubDiv}>
              ...
              <button
                ...
                onClick={(e) => historyHandler(e)}
              >
                {history?.option ? "Hide history" : `Show history ${x?.history?.length}`}
              </button>
            </div>
          ...
          <>
            ...
            <div className={styles.taskInfo}>
              ...
              <div className={styles.author}>
                <img
                  src={x?.in != "todo" ? x?.workOnIt?.image : x?.author.image}
                />
                ...
                <div className={styles.taskBtns}>
                  {edit.option ? (
                    <>
                      <button
                        onClick={() => setEdit({ option: false, value: "" })}
                      >
                        <svg
                          fill="white"
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <>
                      {x.in != "todo" ? (
                        <button onClick={() => onMoveHandler(1)}>
                          <svg
                            fill="white"
                            xmlns="http://www.w3.org/2000/svg"
                            height="1em"
                        ...
                        <>
                          <button
                            onClick={() =>
                              setEdit({ option: true, value: x.title })
                            }
                          >
                            <svg
                              fill="white"
                          ...
                          {(x?.author?._id == user?._id ||
                            currentTask?.admins.some(
                              (y) => y?._id == user?._id
                            )) && (
                              <button onClick={() => onDeleteHandler(x?._id)}>
                                <svg
                                  fill="white"
                                  xmlns="http://www.w3.org/2000/svg"
                                  height="1em"
                      ...
                      {x.in == "done" ? (
                        ...
                        <button onClick={() => onMoveHandler(0)}>
                          <svg
                            fill="white"
                            xmlns="http://www.w3.org/2000/svg"
                            height="1em"
